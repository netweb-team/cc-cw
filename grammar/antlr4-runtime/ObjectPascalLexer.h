...
public:
  enum {
    ...
    Ident = 174, DecimalLiteral = 175, OctalLiteral = 176, HexadecimalLiteral = 177, 
    BinaryLiteral = 178, Integersuffix = 179, UserDefinedIntegerLiteral = 180, 
    UserDefinedFloatingLiteral = 181, UserDefinedStringLiteral = 182, UserDefinedCharacterLiteral = 183, 
    Whitespace = 184, Newline = 185, BlockComment = 186, LineComment = 187, 
    IntegerLiteral = 188, CharacterLiteral = 189, FloatingLiteral = 190, 
    StringLiteral = 191, BooleanLiteral = 192, UserDefinedLiteral = 193, 
    MultiLineMacro = 194
  };
